 ...
 * Copyright 2014-2015 
 * Licensed under MIT
 * Include swiper,jweixin,alertMsg,baseUtils,citySelect,formJSON,formValidator,loadpage,loadingPage,paging,preview,shareWX,tabs,template,ajaxUpload 
 * Update on 2015-08-26 17:28;56 
 */
...
!( function( factory ){
  if (typeof define === "function" && define.amd ) {
    define( 'citySelect',[ "jquery" ], factory );
  } else {
    factory( jQuery );
  }
}( function($){
...
!( function( factory ) {
  if ( typeof define === "function" && define.amd ) {
    define('formJSON',[ "alertMsg", "formValidator" ], factory );
  } else {
...
!(function( factory ) {
  if ( typeof define === "function" && define.amd ) {
    define('loadpage',["jquery", "loadingPage", "alertMsg" ], factory );
  } else {
    factory( jQuery );
  }
...
!( function( factory ) {
  if ( typeof define === "function" && define.amd ) {
    define('template',[ "jquery" ], factory );
  } else {
    var init = factory( jQuery );
    init();
  }
...
!( function( factory ) {
  if ( typeof define === "function" && define.amd ) {
    define('ajaxUpload',[ "jquery" ], factory );
  } else {
    factory( jQuery );
  }
}(function($){
